...
const char *usageMsg = "(-d --models) (-1 --det) (-2 --cls) (-3 --rec) (-4 --keys) (-i --image)\n"\
                       ...
                       "[-a --noAngle] [-A --mostAngle] [-n --noResult]\n\n";
...
const char *optionalMsg = "-t --numThread: value of numThread(int), default: 4\n" \
                          ...
                          "-n --noResult: Disable saving result image and text file, default: Enable\n\n";
...
const char *example3Msg = "Example3: %s -d models -1 det.onnx -2 cls.onnx -3 rec.onnx -4 keys.txt -i 1.jpg -n\n";
